          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="mt-3 space-y-2 text-ink-950">
                <p>Phone: <a href={`tel:${phone}`} className="text-signal-600 hover:text-ink-950 font-medium">{phone}</a></p>
                <p>WhatsApp: <a href={`https://wa.me/${whatsapp.replace(/\D/g, '')}`} className="text-signal-600 hover:text-ink-950 font-medium">{whatsapp}</a></p>
                <p>Email: <a href={`mailto:${email}`} className="text-signal-600 hover:text-ink-950 font-medium">{email}</a></p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="mt-3 text-ink-700">
                Already a customer? <a href="/track" className="text-signal-600 hover:text-ink-950 font-medium">Track your request</a> for
