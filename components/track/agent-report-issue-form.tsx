...
const ISSUE_TYPES = [
  { value: 'outage', label: 'Network outage in my area' },
  { value: 'equipment', label: 'Damaged or missing equipment' },
  { value: 'coverage', label: 'Weak or no coverage' },
  { value: 'general_support', label: 'Suspicious activity near router' },
  { value: 'general_support', label: 'Other' },
];

export function AgentReportIssueForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch('/api/agents/report-issue', {
        method: 'POST',
